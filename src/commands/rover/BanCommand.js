...
class BanCommand extends Command {
  ...
  async fn (msg, args) {
    ...
    if (((msg.member.roles.cache.some(roleslist => config.gameModeratorRole.includes(roleslist))) && config.gameModeratorRole != null) || ((modusers.includes(msg.author.id)) && (modusers != null))) {
        let RBXID = 'Unknown'
        let RBXUSER = 'Unknown'
          try {
